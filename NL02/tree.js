...
function createDropdownItem(item, level = 1) {
    ...
    leftIcon.src = 'images/plus-solid.svg'; // Adjust as needed
...
function constructDropdown(id) {
    let data = [
        {"id": 1, "parent_id": null, "name": "Dashboard"},
        {"id": 3, "parent_id": 1, "name": "สินค้ากำลังนับ"},
        {"id": 4, "parent_id": 3, "name": "Item 1"},
        {"id": 5, "parent_id": 3, "name": "Item 2"},
        {"id": 6, "parent_id": 5, "name": "Item 3"},
        {"id": 7, "parent_id": 1, "name": "ประวัติการนับ"}
    ];
